 ...
 *                    -
 * \author TomicoDEV
 * \file speaker_panel.cpp
 * \brief QT speaker panel implementation
 *
...
void SpeakerPanel::create_layout_()
{
  ...
  QObject::connect(
    send_button_, &QPushButton::released, this,
    &SpeakerPanel::send_speak_goal_);
  QObject::connect(
    cancel_button_, &QPushButton::released, this,
    &SpeakerPanel::cancel_speak_goal_);
}

/**
 * \brief convenience function for setting result's color
 */
...
/**
 * \brief spend speak goal to server
 */
